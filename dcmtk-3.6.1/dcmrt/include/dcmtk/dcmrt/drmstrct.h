...
public:
     ...
     *  @return status, EC_Normal if successful, an error code otherwise
     */
    OFCondition getContoursForROINumber(OFVector<DRTROIContourSequence::Item*>& result);
     ...
     *  @return status, EC_Normal if successful, an error code otherwise
     */
    OFCondition getContoursForROINumber(OFList<DRTROIContourSequence::Item*>& result);
};
